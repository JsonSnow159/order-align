...
public class Excel2DBMember {

    private static final String UPLOAD_URL = "http://localhost:8091/kaileshi/member/uploadMember";
    ...
    public static void main(String[] args) {
        String directoryPath = "/Users/app/Downloads/凯乐石相关/会员补充";
    ...
    private static void uploadBatch(List<String> outTidList) {
        MemberAlignDTO memberAlignDTO = new MemberAlignDTO();
        memberAlignDTO.setAppId("42243307_kylin");
        memberAlignDTO.setRootKdtId(42243307L);
        memberAlignDTO.setMobileList(outTidList);

        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<MemberAlignDTO> request = new HttpEntity<>(memberAlignDTO, headers);

        try {
            System.out.println("Uploading batch of " + outTidList.size() + " member...");
