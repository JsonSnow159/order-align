...
public class Excel2DBRefund {

    private static final String UPLOAD_URL = "http://localhost:8091/kaileshi/refund/updateRefundOrder";
    ...
    public static void main(String[] args) {
        String directoryPath = "/Users/app/Downloads/凯乐石相关/全量退单";
    ...
    private static void uploadBatch(List<String> outTidList) {
        ...
        orderAlignDTO.setAppId("42243307_kylin");
        orderAlignDTO.setRootKdtId(42243307L);
